        ...
        <div class="div-form">
            ...
            <form method="POST" action="cadastro_disciplina.php">
                ...
                <?php if(isset($_GET['cadastro'])){ ?>
                    <p class="cadastro"><?php echo $_GET['cadastro']; ?></p>
                <?php } ?>
            
                <div class="div-inputs">
                   
                    <br />
                    <input id="disciplina" type="text" name="nome_disciplina" class="inputs" onchange="toggleButton()" required="">
                    <label class="lab1">Nome da Disciplina</label>
                   
                    <br /><br /><br />
                    <h3>Periodo referente a disciplina</h3>
                    <br /><br />
                    <select name="id" class="slc_periodo">
                        ...
                        ?>
                            ...
                            <option value="<?php echo $category["id_tema"];?>">
                                <?php echo $category["nome_tema"];?>
                            </option>
                        <?php
                            endwhile;
                        ?>
